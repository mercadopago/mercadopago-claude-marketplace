...
[![Version: 4.4.0](https://img.shields.io/badge/version-4.4.0-green)](./CHANGELOG.md)
...
- **Safer Point integration flow**: Point order expiration is selected explicitly for each integration, and scaffolding never creates a remote test order automatically.
